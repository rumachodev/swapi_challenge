...
import '../bloc/character_detail_bloc/character_detail_bloc.dart';
import '../bloc/statusmode_bloc/statusmode_bloc.dart';
import '../models/character_detail_model.dart';
import '../models/character_model.dart';
import '../models/report_model.dart';
import '../services/character_detail_service.dart';
import '../services/report_service.dart';
import '../utils/utils.dart';
import '../widgets/detail_buton.dart';
    ...
    if (resp['ok'] == true) {
      showDialog(
        ...
        builder: (context) => AlertDialog(
            ...
            content: Text('El reporte fue enviado con éxito'),
          ),
      );
    } else {
          ...
          Table(
            children: [
              ...
              TableRow(children: [
                DetailButton(
                  title: 'Peso',
                  subitle: '${character.mass}',
                  ),
                DetailButton(
                  title: 'Altura',
                  subitle:'${character.height}',
                ),
              ]),
              TableRow(children: [
                DetailButton(
            ...
            children: [
              ...
              TableRow(children: [
                DetailButton(
                  title: 'Genero',
                  subitle:
                      '${character.gender.substring(0, 1).toUpperCase() + character.gender.substring(1, character.gender.length)}',
                ),
                DetailButton(
                  title: 'Planeta',
                  subitle: 'desconocido',
