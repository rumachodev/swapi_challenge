                  ...
                  return Column(
                    children: [
                      ...
                      RichText(
                        ...
                        text: TextSpan(
                          text:
                              'Asegúrese de estar conectado a Internet o en modo online',
                      ...
                      RichText(
                        ...
                        text: TextSpan(
                          text:
                              'Si el problema persiste, póngase en contacto con un administrador',
                          style: TextStyle(fontSize: 16.0, fontFamily: 'Karla'),
                        ),
                      )
                    ],
                ...
                return Column(
                  children: [
                    ...
                    RichText(
                      textAlign: TextAlign.center,
                      text: TextSpan(
                        text: 'Si es tu primera vez en la aplicación',
                        style: TextStyle(fontSize: 16.0, fontFamily: 'Karla'),
                      ),
                    ),
                    RichText(
